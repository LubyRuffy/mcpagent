export default {
  ...
  config: {
    ...
    mcp: {
      ...
      transportType: '传输类型',
      transportTypePlaceholder: '选择传输类型',
      transportStdio: 'STDIO (命令行)',
      transportSSE: 'SSE (服务器发送事件)',
      transportHTTP: 'HTTP (网络请求)',
      command: '命令',
      ...
      headers: 'HTTP头部',
      addHeader: '添加头部',
      headerPlaceholder: '如: Authorization: Bearer token',
      status: '状态',
      selectTools: '选择工具',
      ...
      urlRequired: '请输入服务器URL',
      urlInvalid: '请输入有效的HTTP(S) URL',
